...
## Description
Introducing a CLI-based Sokoban game that offers a engaging experience. Developed in C++ language applying OOPs concepts with built-in Libraries , and Windows.h Library for cursor movements. **It is exclusively playable on Windows OS**.
...
## Objective
Sokoban is a puzzle game in which the player pushes boxes around in a warehouse, trying to get them to designated storage locations. The player can only push the boxes and cannot pull them, making the game both challenging and engaging.The game is designed using OOP principles to ensure clean, modular, and maintainable code.
...
It saves the players name and moves and store it in ascending order everytime the game is completed
<p align="center">
...
- Shah Anas Khan
- [Ali Haider](https://github.com/AliHaider326)
